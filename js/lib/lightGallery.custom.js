...
(function($) {
    ...
    $.fn.lightGallery = function(options) {
        var defaults = {
                container: null, // Add by liuliang
                mode: 'slide',
                useCSS: true,
        ...
        var setUp = {
            ...
            structure: function() {
                var container = settings.container || $('body'); // Add by liuliang
                container.append('<div id="lightGallery-outer" class="' + settings.addClass + '"><div id="lightGallery-Gallery"><div id="lightGallery-slider"></div><a id="lightGallery-close" class="close"></a></div></div>').addClass('lightGallery');
